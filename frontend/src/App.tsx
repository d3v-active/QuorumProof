      ...
      <AppLayout>
        <Suspense fallback={<LoadingFallback />}>
          <Routes>
            ...
            <Route path="/issuer" element={<WalletGuard requireConnection><IssuerManagement /></WalletGuard>} />
            <Route path="/search" element={<CredentialSearch />} />
            <Route path="/help" element={<Help />} />
            <Route path="/slice/new" element={<WalletGuard requireConnection><QuorumSlice /></WalletGuard>} />
            <Route path="/credential/issue" element={<WalletGuard requireConnection><IssueCredential /></WalletGuard>} />
            <Route path="/credential/:id" element={<CredentialDetail />} />
            <Route path="/profile" element={<WalletGuard requireConnection><Profile /></WalletGuard>} />
